...
// Admin login routing
Route::get('/client/login', 'SessionsController@clientCreate');        // login page
Route::post('/client/login', 'SessionsController@clientStore');        // submit login session (log user in)
Route::get('/client/logout', 'SessionsController@clientDestroy');      // destroy login session (log user out)
